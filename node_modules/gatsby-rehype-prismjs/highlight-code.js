...
module.exports = (language, code, additionalEscapeCharacters = {}, lineNumbersHighlight = [], noInlineHighlight = false) => {
  ...
  if (!Prism.languages[language]) {
    try {
      ...
      switch (language) {
        ...
        case `text`:
          message = noInlineHighlight ? `code block language not specified in html.` : `code block or inline code language not specified in html.`;
          break;
